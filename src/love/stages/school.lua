return {
    enter = function()
        ...
        stageImages = {
            ["Sky"] = graphics.newImage(love.graphics.newImage(graphics.imagePath("week6/sky"))), -- sky
			["School"] = graphics.newImage(love.graphics.newImage(graphics.imagePath("week6/school"))), -- school
			["Street"] = graphics.newImage(love.graphics.newImage(graphics.imagePath("week6/street"))), -- street
			["Trees Back"] = graphics.newImage(love.graphics.newImage(graphics.imagePath("week6/trees-back"))), -- trees-back
