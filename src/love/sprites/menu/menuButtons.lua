return graphics.newSprite(
    	...
    	-- Automatically generated from FNF_main_menu_assets.xml
	{
		...
		{x = 1192, y = 167, width = 242, height = 122, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 13: freeplayL basic0000
		{x = 1192, y = 167, width = 242, height = 122, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 14: freeplayL basic0001
		{x = 1192, y = 167, width = 242, height = 122, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 15: freeplayL basic0002
		{x = 0, y = 332, width = 242, height = 122, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 16: freeplayL basic0003
		{x = 0, y = 332, width = 242, height = 122, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 17: freeplayL basic0004
		{x = 0, y = 332, width = 242, height = 122, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 18: freeplayL basic0005
		{x = 494, y = 332, width = 242, height = 122, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 19: freeplayL basic0006
		{x = 494, y = 332, width = 242, height = 122, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 20: freeplayL basic0007
		{x = 494, y = 332, width = 242, height = 122, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 21: freeplayL basic0008
		{x = 988, y = 332, width = 313.5, height = 169, offsetX = 0, offsetY = 0, offsetWidth = 635/2, offsetHeight = 174}, -- 22: freeplayL white0000
		{x = 0, y = 511, width = 316, height = 170, offsetX = 0, offsetY = -1, offsetWidth = 635/2, offsetHeight = 174}, -- 23: freeplayL white0001
		{x = 642, y = 511, width = 314.5, height = 173, offsetX = 0, offsetY = -1, offsetWidth = 635/2, offsetHeight = 174}, -- 24: freeplayL white0002
    ...
    {
        ["donate"] = {start = 1, stop = 9, speed = 24, offsetX = 0, offsetY = 0},
