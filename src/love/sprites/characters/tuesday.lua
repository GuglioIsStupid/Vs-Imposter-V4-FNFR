return graphics.newSprite(
	...
	},
	{
		...
		["singDOWN"] = {start = 61, stop = 70, speed = 24, offsetX = 3, offsetY = -8},
		...
		["tomidle"] = {start = 101, stop = 110, speed = 24, offsetX = -1, offsetY = -45},
		["singUP"] = {start = 111, stop = 120, speed = 24, offsetX = 3, offsetY = 7},
	},
