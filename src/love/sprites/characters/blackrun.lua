return graphics.newSprite(
	...
	},
	{
		...
		["singDOWN"] = {start = 1, stop = 5, speed = 24, offsetX = -169, offsetY = -28},
		["idle"] = {start = 6, stop = 21, speed = 24, offsetX = 0, offsetY = 0},
		["singLEFT"] = {start = 22, stop = 26, speed = 24, offsetX = -35, offsetY = 0},
		["singRIGHT"] = {start = 27, stop = 31, speed = 24, offsetX = -33, offsetY = 33},
		["aggressive shitting"] = {start = 32, stop = 68, speed = 24, offsetX = -41, offsetY = 228},
		["singUP"] = {start = 69, stop = 73, speed = 24, offsetX = -52, offsetY = 44},
	},
