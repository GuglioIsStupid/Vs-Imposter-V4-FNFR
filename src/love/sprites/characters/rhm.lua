return graphics.newSprite(
	...
	},
	{
		...
		["left"] = {start = 162, stop = 176, speed = 24, offsetX = 0, offsetY = 0},
		["up"] = {start = 31, stop = 48, speed = 24, offsetX = 0, offsetY = 0},
		["down"] = {start = 49, stop = 63, speed = 24, offsetX = 0, offsetY = 0},
		["right"] = {start = 16, stop = 30, speed = 24, offsetX = 0, offsetY = 0},
		["intro"] = {start = 64, stop = 161, speed = 24, offsetX = 0, offsetY = 0},
