...
return graphics.newSprite(
	...
	{
		["off"] = {start = 3, stop = 3, speed = 0, offsetX = 0, offsetY = 0},
		["confirm"] = {start = 33, stop = 36, speed = 24, offsetX = 0, offsetY = 0},
		["press"] = {start = 37, stop = 40, speed = 24, offsetX = 0, offsetY = 0},
		["end"] = {start = 32, stop = 32, speed = 0, offsetX = 0, offsetY = 0},
		["on"] = {start = 30, stop = 30, speed = 0, offsetX = 0, offsetY = 0},
		["hold"] = {start = 31, stop = 31, speed = 0, offsetX = 0, offsetY = 0}
	},
	"off",
	false
)
