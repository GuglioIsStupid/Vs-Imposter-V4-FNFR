weeksOld = {
	init = function()
		...
		sheets = {
			["girlfriend"] = love.graphics.newImage(graphics.imagePath("alpha/oldgf")),
			["boyfriend"] = love.graphics.newImage(graphics.imagePath("boyfriend")),
			["icons"] = love.graphics.newImage(graphics.imagePath("icons")),
		}
		
		sprites = {
			["icons"] = love.filesystem.load("sprites/alpha/iconsalpha.lua")
		}
		
		girlfriend = love.filesystem.load("sprites/alpha/oldgf.lua")()
		boyfriend = love.filesystem.load("sprites/alpha/boyfriendalpha.lua")()
	...
	initUI = function()
		...
		sheets["notes"] = love.graphics.newImage(graphics.imagePath("notes"))
		
		sprites["left arrow"] = love.filesystem.load("sprites/alpha/left-arrow.lua")
		sprites["down arrow"] = love.filesystem.load("sprites/alpha/down-arrow.lua")
		sprites["up arrow"] = love.filesystem.load("sprites/alpha/up-arrow.lua")
		sprites["right arrow"] = love.filesystem.load("sprites/alpha/right-arrow.lua")
